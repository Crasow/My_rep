...
print(list_fill_1(1000000))  # Время выполнения: 0.0
...
print(dict_fill_1(1000000))  # Время выполнения: 0.0009953975677490234
...
# stop = time()
# print(f'Время выполнения: {stop - start}')  # Время выполнения: 2.2345762834562342
